package com.gurbanidarshan.activities.guru_sahiban.pageAdapter;
...
public class GuruSahibanListAdapter extends ArrayAdapter<String> {
    ...
    public GuruSahibanListAdapter(Context context, int textViewResourceId, ArrayList<String> objects) {
