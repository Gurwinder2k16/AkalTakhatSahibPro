package com.gurbanidarshan.activities.mainMenu.side_menu_page;
...
import com.gurbanidarshan.activities.About.Activities.AboutAkalTakhatSahib;
import com.gurbanidarshan.activities.About.Activities.AboutSGPC;
...
public class MenuDrawer extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
   ...
   /* private void initInstruction(View view) {
    ...
    void shareApp() {
        ...
        String shareBody = "Download Gurbani Darshan official application by Sri Akal Takhat Sahib Link : https://play.google.com/store/apps/details?id=com.gurbanidarshan&hl=en_IN";
